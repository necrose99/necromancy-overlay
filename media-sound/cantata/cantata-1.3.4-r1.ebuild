...
SRC_URI="https://drive.google.com/uc?export=download&id=0Bzghs6gQWi60WTYtaXk3c1IzNVU -> ${P}.tar.bz2"

LICENSE="GPL-2"
SLOT="4"
KEYWORDS="~amd64 ~x86"
IUSE="cddb cdda dynamic http-server kde lame mtp musicbrainz online-services qt5 replaygain streams taglib udisks http-stream-playback"
REQUIRED_USE="
	cddb? ( cdda taglib )
...
src_configure() {
	...
	local mycmakeargs=(
		...
		$(cmake-utils_use_enable http-stream-playback HTTP_STREAM_PLAYBACK)
