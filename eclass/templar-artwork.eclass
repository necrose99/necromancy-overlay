# Copyright 2004-2009 templar Project
...
GFX_SPLASH_NAME="${GFX_SPLASH_NAME:-templar}"

# @ECLASS-VARIABLE: PLYMOUTH_THEME
# @DESCRIPTION:
# Default plymouth theme name to use
PLYMOUTH_THEME="${PLYMOUTH_THEME:-templar}"
...
# @FUNCTION: update_templar_kernel_initramfs_splash
# @USAGE: update_templar_kernel_initramfs_splash
#
# @MAINTAINER:
# Fabio Erculiani
update_templar_kernel_initramfs_splash() {
