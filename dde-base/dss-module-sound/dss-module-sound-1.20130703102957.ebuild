...
src_install() {
	...
	fperms 0755 -R /usr/share/${DSS}/modules/sound/src/{main.py,card.py,client.py,core.py,device.py,main_full.py,memstat.py,module.py,pulseaudio.py,sample.py,stream.py,tray_main.py}
