...
SRC_URI="amd64? ( http://download.ime.sogou.com/1429000650/sogoupinyin_${PV}_amd64.deb )
 x86? ( http://download.ime.sogou.com/1429000250/sogoupinyin_${PV}_i386.deb )
"
...
pkg_postinst(){
	einfo
	einfo "After install the sogoupinyin fcitx restart is expected."
	einfo
