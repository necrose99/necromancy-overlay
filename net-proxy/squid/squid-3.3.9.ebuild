...
inherit autotools eutils linux-info pam toolchain-funcs user versionator systemd
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-3.3.8-systemd.patch"
...
src_install() {
	...
	systemd_dounit "${FILESDIR}"/squid.socket
