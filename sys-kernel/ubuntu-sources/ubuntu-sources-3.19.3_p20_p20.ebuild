...
SRC_URI="${UURL}/${MY_PN}_${BASE_PV}.orig.tar.gz
	...
	amd64? ( http://kernel.ubuntu.com/~kernel-ppa/configs/${KCONFIG_URELEASE}/amd64-config.flavour.lowlatency )
	x86? ( http://kernel.ubuntu.com/~kernel-ppa/configs/${KCONFIG_URELEASE}/i386-config.flavour.lowlatency )"
LICENSE="GPL-2"
KEYWORDS="~x86 ~amd64"
IUSE=""
...
pkg_setup() {
	...
	defconfig_src="${DISTDIR}/${defconfig_src}-config.flavour.lowlatency"
