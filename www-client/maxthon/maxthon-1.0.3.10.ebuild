...
SRC_URI="
	amd64? (
		http://dl.maxthon.com/linux/deb/packages/amd64/maxthon-browser-stable_${PV}_amd64.deb		
	)
	x86? (
		http://dl.maxthon.com/linux/deb/packages/i386/maxthon-browser-stable_${PV}_i386.deb
	)
"		  
...
pkg_postinst() {
	...
	elog
	elog "After the choice of words found more exciting <Control> <Shift> X~"
	elog
}
