...
src_install() {
	for library in UsageEnvironment liveMedia BasicUsageEnvironment groupsock; do
		...
		dosym /usr/$(get_libdir)/libliveMedia.so.6 /usr/$(get_libdir)/libliveMedia.so.23
		dosym /usr/$(get_libdir)/libgroupsock.so.6 /usr/$(get_libdir)/libgroupsock.so.1
		dosym /usr/$(get_libdir)/libBasicUsageEnvironment.so.6 /usr/$(get_libdir)/libBasicUsageEnvironment.so.0
		dosym /usr/$(get_libdir)/libUsageEnvironment.so.6 /usr/$(get_libdir)/libUsageEnvironment.so.1
