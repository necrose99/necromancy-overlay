...
SRC_URI=" x86? ( http://repo.acestream.org/ubuntu/pool/main/a/acestream-engine/acestream-engine_2.1.6-1raring4_i386.deb
				 http://stuff.tazhate.com/distfiles/acestream-engine_2.1.6-1raring4_i386.deb )
		amd64? ( http://repo.acestream.org/ubuntu/pool/main/a/acestream-engine/acestream-engine_2.1.6-1raring4_amd64.deb
				 http://stuff.tazhate.com/distfiles/acestream-engine_2.1.6-1raring4_amd64.deb )"
...
DEPEND="dev-python/m2crypto[${PYTHON_USEDEP}]
		...
		gtk? ( >=dev-libs/libappindicator-12.10.1_p0_p02 )"
RDEPEND="${DEPEND}"
